...
export const hoverPositions: {
  [key: number]: { tx: number; ty: number; rotate: number; delay: number }[];
} = {
  0: [
    { tx: 2, ty: -20, rotate: 0, delay: 0 },
    { tx: 70, ty: 0, rotate: 0, delay: 0.02 },
  ...
  2: [
    ...
    { tx: -20, ty: 0, rotate: 0, delay: 0.02 },
    { tx: 0, ty: -20, rotate: 0, delay: 0 },
    { tx: 90, ty: 0, rotate: 0, delay: 0.02 },
    { tx: 70, ty: 0, rotate: 0, delay: 0.04 },
    { tx: 30, ty: 0, rotate: 0, delay: 0.06 },
